...
// export class SyncaMirakl implements INodeType {
// 	description: INodeTypeDescription = {
// 		displayName: 'Synca Mirakl',
// 		name: 'customSyncaMirakl',
// 		icon: 'fa:shopping-cart',
// 		group: ['transform'],
// 		version: 1,
// 		description: 'Comprehensive Mirakl Marketplace API integration for Orders, Offers, Products, Inventory, Messages, Shipping, and more',
// 		defaults: {
// 			name: 'Synca Mirakl',
// 		},
...
// 				default: '',
// 				required: true,
// 				description: 'Select the Mirakl API credentials to use',
// 			},
// 			{
...
// 					return [
// 						{
// 							name: 'Default Mirakl Credentials',
// 							value: 'default',
// 						},
// 					];
// 				}
...
// 				this.addResourceSpecificParams(requestParams, resource, operation, i);
...
// 				this.logger?.debug('Mirakl API Request', { 
// 					action: operation, 
// 					resource,
// 					url: options.url,
...
// 					responseData = await this.makeRequestWithRetry(options, 3);
// 				} else {
...
// 					const processedData = this.processResponseData(responseData, resource, operation);
					
// 					if (this.isListOperation(operation) && Array.isArray(processedData)) {
...
// 			} catch (error: any) {
// 				this.logger?.error('Mirakl API Error', { 
// 					error: error.message,
...
// 	private addResourceSpecificParams(requestParams: any, resource: string, operation: string, itemIndex: number): void {
...
// 			try {
// 				const value = this.getNodeParameter(field, itemIndex, null);
...
// 	private async makeRequestWithRetry(options: IHttpRequestOptions, maxRetries: number): Promise<any> {
// 		let attempt = 0;
...
// 					this.logger?.warn(`Rate limited, retrying in ${waitTime}ms`, { attempt });
...
// 	private processResponseData(responseData: any, resource: string, operation: string): any {
...
// 	private isListOperation(operation: string): boolean {
