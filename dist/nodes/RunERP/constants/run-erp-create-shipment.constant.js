...
exports.RunErpCreateShipment = void 0;
exports.RunErpCreateShipment = {
    declare: [
        {
    ...
    process: (params, i, getNodeParameter) => {
        params.type = getNodeParameter('type', i);
        params.consignee_name = getNodeParameter('consignee_name', i);
        params.city = getNodeParameter('city', i);
        params.street = getNodeParameter('street', i);
        params.phone = getNodeParameter('phone', i);
        params.destination_type = getNodeParameter('destination_type', i);
        const addressDetails = getNodeParameter('addressDetails', i, {});
        if (addressDetails) {
        ...
        const contactReference = getNodeParameter('contactReference', i, {});
        if (contactReference) {
        ...
        const packageDetails = getNodeParameter('packageDetails', i, {});
        if (packageDetails) {
        ...
        const scheduling = getNodeParameter('scheduling', i, {});
        if (scheduling) {
        ...
        const pickupPoints = getNodeParameter('pickupPoints', i, {});
        if (pickupPoints) {
        ...
        const paymentCollection = getNodeParameter('paymentCollection', i, {});
        ...
        const returnOptions = getNodeParameter('returnOptions', i, {});
        if (returnOptions) {
        ...
        const advancedOptions = getNodeParameter('advancedOptions', i, {});
        if (advancedOptions) {
...
//# sourceMappingURL=run-erp-create-shipment.constant.js.map